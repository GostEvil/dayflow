...
export function JournalPage() {
 ...
 return (
 <div className="p-6 sm:p-12 lg:p-16 max-w-[1400px] mx-auto space-y-12">
 {/* Header */}
 ...
 <p className="text-sm text-text leading-relaxed line-clamp-4 mb-4">{entry.content}</p>
 ...
 <span
 key={tag}
 className="px-3 py-1.5 bg-surface-2 text-text-muted text-xs rounded-lg font-mono border border-border/40"
 >
 #{tag}
 </span>
 ))}
 ...
 <div className="flex gap-4 flex-wrap mt-6 pt-4 border-t border-border/40">
